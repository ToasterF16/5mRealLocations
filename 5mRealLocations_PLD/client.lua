...
Citizen.CreateThread(function()
 ...
 AddTextEntryByHash(0x5FA0E6BF, "Santa Monica Freeway I-10")
 ...
 AddTextEntryByHash(0x12057A99, "Santa Monica Freeway I-10")
 ...
 AddTextEntryByHash(0xC8690C80, "Santa Monica Freeway I-10")
 ...
 AddTextEntryByHash(0xA5C7829A, "Complex time trial that takes you from the glamourous peaks of the Hollywood Hills to the grimey troughs of the Needles shoreline. Sober up fast - there's no easy route.")
 ...
 AddTextEntryByHash(0xDE65DFA8, "Orange Grove Ave")
 ...
 AddTextEntryByHash(0xEC99478C, "Western Ave Lower")
 ...
 AddTextEntryByHash(0x2E49B265, "Long Beach Freeway I-710")
 AddTextEntry("HARBOR_BLUE", "Harbor Blue")
 AddTextEntry("LOSPFY", "Harbor Freeway I-110")
 AddTextEntryByHash(0x514F7C6D, "Golden State Freeway I-5")
 ...
 AddTextEntry("LOSSF", "Golden State Freeway I-5")
 AddTextEntryByHash(0x7EFE76C9, "Garage: Unit 1 Century Freeway I-105")
 AddTextEntryByHash(0x22F73EE4, "Unit 1 Century Freeway I-105")
 AddTextEntryByHash(0x192E8516, "Century Freeway I-105")
 AddTextEntryByHash(0xAF887EF2, "State Route 15")
 AddTextEntryByHash(0xBC386BDB, "State Route 15")
 AddTextEntryByHash(0xE67489E0, "Century Freeway I-105")
 AddTextEntryByHash(0xF5DE6511, "State Route 15")
 AddTextEntryByHash(0xF83C4076, "State Route 15")
 AddTextEntry("MP_PROP_28", "Unit 1 Century Freeway I-105")
 AddTextEntryByHash(0x0961A45F, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x2C0CF801, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x3FD5BBA0, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x4E05D239, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x44A1A0E0, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x86DEB6E8, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x540B5C61, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x697CC7BC, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xAF87DBCA, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xBCF76D55, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xC393BE32, "For once, let a low-T CEO on his daily commute scream at you instead of his executive assistant. Time trial out of LS along the one-percent-crammed Pacific Coast Highway CA-1.")
 AddTextEntryByHash(0xC880DA51, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xCAAD46CB, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xCE3C45A2, "Garage: Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xD1E9710A, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xD2AF9ED1, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xEA442195, "Mr. De Santa!  ~n~Congratulations on being the new owner of Hookies!  Aside from a minor gang problem and the occasional drunken knife fight, there isn't a better family restaurant in all of Pacific Coast Highway CA-1!  ~n~I've worked the bar at Hookies for over 30 years, and I'm only 42 so I really have grown up with the place!  Anything you need, just let me know.  ~n~Best,~n~Franny")
 AddTextEntryByHash(0xEAC55569, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xFDA84086, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x1CF1CCB4, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xE7932A4B, "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0xFFDD8824, "Get a beach body the American way. Eat a four pound, microwave-fresh burger then hit a time trial from Up-n-Atom to Pacific Coast Highway CA-1. Just hope catastrophic heart failure doesn't hit you 'til next year.")
 AddTextEntry("EMSTR_375", "Mr. Clinton!~n~Congratulations on being the new owner of Hookies!  Aside from a minor gang problem and the occasional drunken knife fight, there isn't a better family restaurant in all of Pacific Coast Highway CA-1!  ~n~I've worked the bar at Hookies for over 30 years, and I'm only 42 so I really have grown up with the place!  Anything you need, just let me know.  ~n~Best,~n~Franny")
 AddTextEntry("MP_PROP_49", "2000 Pacific Coast Highway CA-1")
 AddTextEntry("MP_PROP_49DES", "2-Car Garage - Across from the beach, ocean views, steps from a delicious seafood restaurant, this property on Pacific Coast Highway CA-1 in Pacific Coast Highway CA-1 is in an unbeatable location! The catch? It's a garage...")
 AddTextEntry("NCHU", "Pacific Coast Highway CA-1")
 AddTextEntry("YACHT_LOC_0", "Pacific Coast Highway CA-1")
 AddTextEntryByHash(0x5AB2461E, "@creammonster42 Driving home down the US Highway 101 and I see a guy riding a motorbike on top of a fucking train! No shit!")
 AddTextEntryByHash(0x77A09E3D, "@tacobrendan_who I leave the van for 2 minutes to do a shit and get a parking ticket then on the way home I see 3 sportscars racing on the US Highway 101 at like 120mph and nobody doing anything. My karma's screwed.")
 AddTextEntry("SENORA", "US Highway 101")
 AddTextEntry("ZENORA", "US Highway 101")
 ...
 AddTextEntryByHash(0x009D382A, "Needles")
 AddTextEntryByHash(0x0887C1EB, "Needles Forgery Office")
 AddTextEntryByHash(0x3F769FD9, "Needles")
 AddTextEntryByHash(0x4A08C9CB, "Needles")
 AddTextEntryByHash(0x4DCE72D8, "Needles Ave")
 AddTextEntryByHash(0x5DCE4604, "Needles Ave")
 AddTextEntryByHash(0x7BB04716, "Needles")
 AddTextEntryByHash(0x7E0A8680, "Garage: 1932 Needles Ave")
 AddTextEntryByHash(0x7F870413, "Needles Bunker")
 AddTextEntryByHash(0x61EF61D5, "Apt: 1893 Needles Ave")
 AddTextEntryByHash(0x79AB86B9, "Needles")
 AddTextEntryByHash(0x140DC61B, "Garage: 1893 Needles Ave")
 AddTextEntryByHash(0x381F19DE, "Needles")
 AddTextEntryByHash(0x618D7452, "Needles Train Depot")
 AddTextEntryByHash(0x3132B9A5, "Needles Main St")
 AddTextEntryByHash(0x5286CD1B, "Needles Main St")
 AddTextEntryByHash(0x7663D8C9, "Amid all this talk of the death of small-town America, it's important to remember that somewhere like Needles has an advantage over the big city: there's plenty of space for the one percent to build subterranean lairs in preparation for the apocalypse. Hey, the heartlands aren't going to rejuvenate themselves.")
 AddTextEntryByHash(0x26983A25, "@kevtrimbalt22 Did u hear about those planes stolen from Needles airport? How the fuck does somebody steal a plane when I can't even get a lighter through security?")
 AddTextEntryByHash(0x7645694A, "Needles Ave")
 AddTextEntryByHash(0x26703622, "Needles base")
 AddTextEntryByHash(0xA6A5AAE2, "Wonderama - Needles")
 AddTextEntryByHash(0xA5848676, "Needles Clubhouse")
 AddTextEntryByHash(0xAB65C5FE, "Needles Main St")
 AddTextEntryByHash(0xAD066037, "Needles Clubhouse")
 AddTextEntryByHash(0xB5C67D26, "Needles Ave")
 AddTextEntryByHash(0xB377E4EE, "Go to the ~y~Needles.")
 AddTextEntryByHash(0xC635354D, "Needles")
 AddTextEntryByHash(0xCCA4CA18, "Needles Ave")
 AddTextEntryByHash(0xD497CB67, "Travel to Needles and recover the champagne for Palms Trax to be delivered back to The Music Locker.")
 AddTextEntryByHash(0xE3A9D4AC, "Needles")
 AddTextEntryByHash(0xE24FAFE1, "Back in the 80s, Wonderama was the greatest night out in Needles. Ten-pin bowling, soft play, kids' parties and parties of kids running feral for days. You name it, they had it. But it just takes one health inspector and an infested ball pit and suddenly you're out of business. Bad luck for them. Good luck for you.")
 AddTextEntryByHash(0xE55779FD, "Needles")
 AddTextEntryByHash(0xE3919166, "Go to ~HUD_COLOUR_YELLOW~Needles.")
 AddTextEntryByHash(0xF59D092E, "1893 Needles Ave")
 AddTextEntryByHash(0xFA78E0F0, "Needles")
 AddTextEntryByHash(0xFAD11C47, "Needles")
 AddTextEntry("GRAPES", "Needles")
 AddTextEntry("MP_PROP_46", "1932 Needles Ave")
 AddTextEntry("MP_PROP_46DES", "2-Car Garage - The town of Needles offer a unique blend of heavy industry and genetically-modified farming that explains why everyone born there in the last 20 years looks so funny. This small garage on Needles Ave needs some TLC but is priced to sell.")
 AddTextEntry("MP_PROP_78", "1893 Needles Ave")
 AddTextEntry("MP_PROP_78DES", "Part of The Independence Day Special. Location, location, location! Across from a feed store, minimart and discount clothes emporium, this house is right in the heart of the action on Needles's main drag. Living on the cutting edge of rural retail! Includes 2-car garage.")
 ...
 AddTextEntryByHash(0x01946715, "1984 Barstow Rd")
 ...
 AddTextEntryByHash(0x7FCABBAD, "Barstow Rd")
 ...
 AddTextEntryByHash(0x410EAEB9, "Barstow Rd")
 AddTextEntryByHash(0x19675F2B, "Garage: 1920 Barstow Rd")
 AddTextEntryByHash(0xA5ED152A, "Barstow Rd")
 AddTextEntryByHash(0xC7A93BB0, "Barstow Rd")
 AddTextEntryByHash(0xC147A270, "Barstow Rd")
 ...
 AddTextEntryByHash(0xD2071778, "Barstow Rd")
 AddTextEntry("MP_PROP_48", "1920 Barstow Rd")
 AddTextEntry("MP_PROP_48DES", "2-Car Garage - This garage is situated on the site of Ron Alternates on N. Barstow Rd. What better way to feel better about your carbon footprint than by storing your gas-guzzlers inside a wind farm?")
 ...
 AddTextEntryByHash(0x0B7DCE80, "Go to the Fleeca on Route 86")
 AddTextEntryByHash(0x11D35F91, "Route 86")
 AddTextEntryByHash(0x13F60876, "Route 86")
 AddTextEntryByHash(0x29A56312, "Route 86 Facility")
 AddTextEntryByHash(0x98BB8F8E, "Garage: 1200 Route 86")
 AddTextEntryByHash(0x195C6A3D, "Go to the Fleeca on ~HUD_COLOUR_YELLOW~Route 86.")
 AddTextEntryByHash(0x827B6EAB, "Route 86")
 AddTextEntryByHash(0x6010FAA1, "101 Route 86")
 AddTextEntryByHash(0x60781F08, "1200 Route 86")
 AddTextEntryByHash(0x762363B1, "Route 86")
 AddTextEntryByHash(0xA45B015C, "Race to the Fleeca on ~HUD_COLOUR_YELLOW~Route 86.")
 AddTextEntryByHash(0xAA8D30DD, "197 Route 86")
 AddTextEntryByHash(0xAE282D43, "8754 Route 86")
 AddTextEntryByHash(0xAF414BCA, "When you're thinking of investing in a labyrinthine military-grade vault hundreds of feet below ground, the address is everything. Just off the iconic Route 86, surrounded by mountain peaks, this little number is just the country retreat you've been looking for.")
 AddTextEntryByHash(0xB6C72634, "Race to the Fleeca on Route 86")
 AddTextEntryByHash(0xC0EEDED4, "Garage: 870 Route 86")
 AddTextEntryByHash(0xC4050D0E, "Route 86 Bunker")
 AddTextEntryByHash(0xCA97E626, "Garage: 8754 Route 86")
 AddTextEntryByHash(0xDC13B9CD, "Route 86 Facility")
 AddTextEntryByHash(0xDD3448BF, "Route 86 Approach")
 AddTextEntryByHash(0xEC91B5E5, "870 Route 86")
 AddTextEntryByHash(0xEF9EBAFF, "Garage: 197 Route 86")
 AddTextEntryByHash(0xF5C37F6E, "Route 86")
 AddTextEntryByHash(0xFE7D2BD2, "Go to ~HUD_COLOUR_YELLOW~Route 86.~s~")
 AddTextEntry("MP_PROP_50", "197 Route 86")
 AddTextEntry("MP_PROP_50DES", "2-Car Garage - Small one-door garage for sale on Route 86 on Victorville. With a rundown general store, a local arm-wrestling haunt and a seedy motel all nearby, park up and live the dream!")
 AddTextEntry("MP_PROP_51", "870 Route 86 Approach")
 AddTextEntry("MP_PROP_52", "1200 Route 86")
 AddTextEntry("MP_PROP_52DES", "2-Car Garage - Steps from a liquor store, a Dollar Pills pharmacy, a Suburban store, and an Animal Ark pet store, this garage on Route 86 in Victorville is a hipster's dream. Booze, cigarettes, faux-vintage clothing and organic dog food in one!")
 AddTextEntry("MP_PROP_57", "8754 Route 86")
 AddTextEntry("MP_PROP_57DES", "6-Car Garage - Located behind an Ammu-Nation store and near to the Naval Base Ventura County Military Base, you won't have to worry about security at this garage on Route 86.")
 ...
 AddTextEntryByHash(0x2B2B29A4, "Plant the tracker underneath either side of the transporter ~HUD_COLOUR_BLUE~~BLIP_TRAILER~~s~. This will allow its location to be tracked when the convoy is leaving Naval Base Ventura County during the Contract Job.")
 AddTextEntryByHash(0x2D66E88E, "Naval Base Ventura County")
 AddTextEntryByHash(0x5ADFBA82, "Naval Base Ventura County")
 AddTextEntryByHash(0x5EF67804, "WARNING: Your clearance level does not permit you to fire explosives inside Naval Base Ventura County. Continuing to fire explosives will result in a Wanted Level.")
 AddTextEntryByHash(0x6C620C75, "The Crusader ~HUD_COLOUR_WHITE~~BLIP_CRUSADER~~s~ can be stolen and used to infiltrate Naval Base Ventura County undetected.")
 AddTextEntryByHash(0x6CCFE87A, "Leave Naval Base Ventura County.")
 AddTextEntryByHash(0x6EE4F773, "Naval Base Ventura County")
 AddTextEntryByHash(0x8D2D4DB4, "Wait for your Organization to leave Naval Base Ventura County.")
 AddTextEntryByHash(0x8E2276E3, "Naval Base Ventura County")
 AddTextEntryByHash(0x9D8AC95A, "~a~ has reportedly entered Naval Base Ventura County military base. The armed forces are attempting to resolve the situation.")
 AddTextEntryByHash(0x13A5583C, "Naval Base Ventura County Treatment Works")
 AddTextEntryByHash(0x22DB2F59, "Naval Base Ventura County")
 AddTextEntryByHash(0x24F2000E, "Naval Base Ventura County")
 AddTextEntryByHash(0x62EE8AA7, "When it comes to hiding in plain sight, it doesn't get much plainer than the largest military installation in the state. On the plus side, they won't ask if you won't tell, and if you need to do any advanced interrogation you're welcome to borrow the bucket. Please note: this hangar provides the buyer with low level clearance to Naval Base Ventura County.")
 AddTextEntryByHash(0x82F2F59D, "The Crusader can be used to enter Naval Base Ventura County without being detected by the security cameras.")
 AddTextEntryByHash(0x85DF8518, "Naval Base Ventura County")
 AddTextEntryByHash(0x87E3F183, "A Business Battle has started. Enter the hangar in Naval Base Ventura County ~HUD_COLOUR_YELLOW~~BLIP_BAT_CARGO~~s~ to access the Goods. Deliver them to the drop-off to earn cash and RP.")
 ...
 AddTextEntryByHash(0x904E1A5A, "Naval Base Ventura County")
 AddTextEntryByHash(0x23115ED2, "Pavel has secured you a temporary clearance level to enter Naval Base Ventura County freely. However, the base will go on full alert after the Alkonost is stolen.")
 AddTextEntryByHash(0xA8ED7082, "Naval Base Ventura County Hangar 3499")
 AddTextEntryByHash(0xAE201E78, "Naval Base Ventura County")
 AddTextEntryByHash(0xB8EE5D0E, "Infiltrate the control tower at Naval Base Ventura County to download the location of the Akula helicopter.")
 AddTextEntryByHash(0xB77606CE, "If you want to stay under the radar coming into Naval Base Ventura County this hot, you better be prepared to take it off road.")
 AddTextEntryByHash(0xBC431108, "Enter ~HUD_COLOUR_YELLOW~Naval Base Ventura County.~s~")
 AddTextEntryByHash(0xBF479D36, "Naval Base Ventura County Hangar 3497")
 ...
 AddTextEntryByHash(0xCC92D034, "Follow in the panicked footsteps of deserters, waterboarded detainees, and peace protesters who didn't think the wars would go on this long. Pacey time trial away from Naval Base Ventura County towards the city lights.")
 AddTextEntryByHash(0xCDA339ED, "Naval Base Ventura County Hangar A2")
 AddTextEntryByHash(0xCE4456E8, "Naval Base Ventura County")
 AddTextEntryByHash(0xF7B3A2CF, "Wait for your Motorcycle Club to leave Naval Base Ventura County.")
 AddTextEntryByHash(0xF682EDC2, "Naval Base Ventura County")
 AddTextEntryByHash(0xF641831C, "Naval Base Ventura County Approach Rd")
 AddTextEntryByHash(0xFB2C849C, "Naval Base Ventura County military base is on high alert due to suspect ~a~ who has entered the restricted area. The armed forces are attempting to resolve the situation.")
 AddTextEntry("ARMYB", "Naval Base Ventura County")
 AddTextEntry("CM_LOC_10", "Naval Base Ventura County")
 AddTextEntry("DCKP2B_R", "Boss, you asked me to remind you about getting that chopper from Naval Base Ventura County. I know you haven't forgotten have you?")
 AddTextEntry("DCKP2B_U", "Only place to get the kind of chopper you need is Naval Base Ventura County, boss. Watch out for other helis in the area. Might be easier if you take em out first. W4de")
 AddTextEntry("GB_ASLT_GO1", "~y~Naval Base Ventura County")
 AddTextEntry("GB_ASLT_MZAN", "New Contract Alert: Source a particular tank from Naval Base Ventura County Military Base for one of our international clients. Drop-off location will be provided when you have the tank. Warning: The tank will be protected, and multiple VIPs could be competing for this contract.")
 AddTextEntry("PIM_MAGM206_1", "Naval Base Ventura County")
 ...
 AddTextEntryByHash(0x69AEF6A3, "Tehachapi Pass Wind Farm")
 AddTextEntryByHash(0x95B9CAB2, "Vehicle: ~a~~n~Color: ~a~~n~Plate: ~a~~n~ Location: Tehachapi Pass Wind Farm ~nrt~ <img src='img://MP_EX_LOCATION_08/MP_EX_LOCATION_08' vspace='0' width='252' height='150'/> ~nrt~")
 AddTextEntryByHash(0x394103A9, "Ron Wind Farm Facility")
 AddTextEntryByHash(0xE8CDD341, "Tehachapi Pass Wind Farm")
 AddTextEntryByHash(0xED6E949D, "Tehachapi Pass Wind Farm")
 ...
 AddTextEntry("WINDF", "Tehachapi Pass Wind Farm")
 ...
 AddTextEntryByHash(0x3AAA67A2, "Desert Shores")
 AddTextEntryByHash(0x5B6F2B06, "Desert Shores Airfield")
 AddTextEntryByHash(0x6A09F353, "Vehicle: ~a~~n~Color: ~a~~n~Plate: ~a~~n~ Location: Desert Shores ~nrt~ <img src='img://MP_EX_LOCATION_10/MP_EX_LOCATION_10' vspace='0' width='252' height='150'/> ~nrt~")
 AddTextEntryByHash(0x7FB608D3, "Desert Shores")
 AddTextEntryByHash(0x8F292BA8, "Desert Shores")
 AddTextEntryByHash(0x9D375DEE, "Desert Shores Sheriff's Station")
 AddTextEntryByHash(0x13B17CA1, "Desert Shores Airfield")
 AddTextEntryByHash(0x25E6AA10, "Desert Shores Airfield")
 AddTextEntryByHash(0x46F88BED, "Go to ~y~Desert Shores.")
 AddTextEntryByHash(0x76C7FC76, "Desert Shores Facility")
 AddTextEntryByHash(0x89F2E39B, "Desert Shores")
 AddTextEntryByHash(0x99A7777C, "Desert Shores Airfield")
 AddTextEntryByHash(0x332BD33D, "Desert Shores Airfield")
 AddTextEntryByHash(0x467EFB96, "Contract Alert: The Desert Shores police are holding a quad bike which may or may not have been used by our client in operations in and around Blaine County. Recover it from the Station and return to one of our safe locations.")
 AddTextEntryByHash(0x557DAA99, "Desert Shores Airfield")
 AddTextEntryByHash(0x693A9C63, "Desert Shores")
 AddTextEntryByHash(0x861BC8E1, "Desert Shores Clubhouse")
 AddTextEntryByHash(0x1234D9F9, "Desert Shores")
 AddTextEntryByHash(0x3116CF73, "These days, Desert Shores is an up and coming second home hotspot for the criminally deranged, and here's your chance to jump the waiting list. Act now: in this neighborhood an abandoned military installation won't be on the market for long.")
 AddTextEntryByHash(0x24802C44, "RE: Hello from Desert Shores! We miss you.")
 AddTextEntryByHash(0x52971648, "Desert Shores Airfield")
 AddTextEntryByHash(0xA7CC1F09, "Go to ~y~Desert Shores Airfield.")
 AddTextEntryByHash(0xA63C4D6F, "Desert Shores")
 AddTextEntryByHash(0xB1F96599, "Desert Shores Facility")
 AddTextEntryByHash(0xBD63C785, "Desert Shores Airfield")
 AddTextEntryByHash(0xCB2827A4, "Desert Shores Medical Center")
 AddTextEntryByHash(0xD92F4EA3, "Desert Shores Clubhouse")
 AddTextEntryByHash(0xD3547423, "Desert Shores Medical Center")
 AddTextEntryByHash(0xEF6AB527, "Desert Shores Airfield")
 AddTextEntryByHash(0xF43F9F95, "Desert Shores Airfield")
 AddTextEntryByHash(0xF991750A, "Desert Shores Airfield")
 AddTextEntryByHash(0xFF5B61F3, "Hello from Desert Shores! We miss you.")
 AddTextEntry("ACCNA_H_SS", "Desert Shores Hospital")
 AddTextEntry("ACCNA_PD_SS", "Desert Shores PD Bail")
 AddTextEntry("AM_H_LHNGR", "Trevor has taken ownership of The Lost's Desert Shores Airfield. This location contains storage for planes at ~HUD_COLOUR_TREVOR~~BLIP_HANGAR~~s~ and helicopters at ~HUD_COLOUR_TREVOR~~BLIP_HELIPAD~")
 AddTextEntry("CM_LOC_8", "Desert Shores")
 AddTextEntry("GB_BB_GT_PS4", "Desert Shores Police Station")
 AddTextEntry("GB_BB_PS4", "Desert Shores Police Station")
 AddTextEntry("GB_INTTXT_BOB4", "Contract Alert: The Desert Shores police are holding quad bikes which may or may not have been used by our clients in operations in and around Blaine County. Recover them from the Station and return to one of our safe locations.")
 AddTextEntry("HANGAR_NAME2", "Desert Shores Hangar")
 AddTextEntry("HELIPAD_NAME2", "Desert Shores Helipad")
 AddTextEntry("MP_PROP_77DES", "Part of The Independence Day Special. Beggars CAN be choosers! Waterfront living at a bargain price! Steps away from both a Chinese restaurant and a tattoo parlor, this Desert Shores location offers no shortage of late-night decisions you'll regret in the morning. Includes 2-car garage.")
 AddTextEntry("SANDY", "Desert Shores")
 AddTextEntry("T_LOST_HANGER", "You shoulda recieved payment from Oscar Guzman already, right. You know, I'm thinking that runway we took off from, Desert Shores Airfield, the Lost're all cleared out from there, so we can have exclusive usage - go over and check it out.")
 ...
 AddTextEntryByHash(0xC393BE32, "For once, let a low-T CEO on his daily commute scream at you instead of his executive assistant. Time trial out of LA along the one-percent-crammed Pacific Coast Highway CA-1.")
 ...
 AddTextEntryByHash(0x8519F0E9, "Elevado Ave")
end)