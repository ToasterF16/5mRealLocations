...
Citizen.CreateThread(function()
 ...
 AddTextEntryByHash(0x28B138F9, "On one side, you hear the bubbling stream of the Zancudo River taking its share of bloated corpses from the Alamo Sea to the coast; on the other, the distant sound of whooping and gunfire from nearby Victorville. And beneath your feet a sprawling nuclear fortress. Welcome to Eden.")
 ...
 AddTextEntryByHash(0x804A8588, "Like a wild-eyed junior exec trying to impress on an extreme-sports team builder, risk soiling yourself all the way along the  Bixby Creek rapids. Time trial from the Pacific shoreline to the Alamo Sea.")
 AddTextEntryByHash(0xA1CB4BFD, "Like every post-hipster tourist with a camera phone, take a tour of crushed dreams in the Alamo Sea and think about what filter best captures the sadness. Time trial for the Snapmatic generation.")
 AddTextEntryByHash(0xA33EF606, "Alamo")
 AddTextEntryByHash(0xB6EFBA9D, "Alamo Sea")
 AddTextEntryByHash(0xB667CCF3, "Alamo Fruit Market")
 AddTextEntryByHash(0xC968459C, "The Alamo Sea is the new hot spot for hipsters, thrill-seekers and people ready to live on the edge.")
 AddTextEntryByHash(0xD6ED44A7, "The Fall of the Alamo")
 AddTextEntryByHash(0xDE3C4509, "Alamo Sea Triathlon")
 AddTextEntryByHash(0xF932DE84, "2 car Garage with direct access to Alamo Sea.")
 AddTextEntry("ALAMO", "Alamo Sea")
 AddTextEntry("BJ_JUMP_11", "The Fall of the Alamo")
 AddTextEntry("HUD_MG_TRI_ALA", "Alamo Sea")
